...
// Some Arduino build systems (especially when compiling a single .ino) may not
// automatically compile .cpp files placed in subfolders. Include the
// implementation directly to ensure the methods are available at link time.
#include "SoftI2cMaster/SoftI2cMaster.cpp"
